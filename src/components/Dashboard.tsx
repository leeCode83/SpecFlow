...
const statCards = [
  ...
  { icon: Zap, label: 'Hackathons', key: 'hackathon' as const, accentClass: 'bg-primary/20 text-primary' },
  { icon: Rocket, label: 'Startups', key: 'startup' as const, accentClass: 'bg-success/20 text-emerald-500' },
    ...
    return (
      <div className="p-8 max-w-7xl mx-auto space-y-8 pb-20">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card/60 rounded-3xl border border-border/50 p-4 space-y-4">
            {Array.from({ length: 4 }).map((_, i) => (
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 pb-20">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-card/60 rounded-3xl border border-border/50 overflow-hidden">
