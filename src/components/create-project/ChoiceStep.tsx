      ...
      <motion.div variants={staggerItem} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="relative h-full rounded-3xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl p-8 space-y-6 flex flex-col items-center text-center group-hover:border-brand/30 transition-colors">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-foreground">Ideation Workshop</h3>
              <p className="text-muted-foreground leading-relaxed text-sm max-w-xs">
                Let AI help you brainstorm, validate, and refine your idea before diving into technical details.
              </p>
            </div>
            <div className="flex flex-wrap gap-2 justify-center">
              <span className="px-2.5 py-1 rounded-full bg-primary/10 text-primary/80 text-[11px] font-medium">AI-Powered</span>
              <span className="px-2.5 py-1 rounded-full bg-white/[0.05] text-muted-foreground text-[11px] font-medium">Brainstorming</span>
              <span className="px-2.5 py-1 rounded-full bg-white/[0.05] text-muted-foreground text-[11px] font-medium">Validation</span>
            </div>
            <div className="flex-1" />
            <div className="w-full flex items-center justify-center gap-2 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] py-3 text-sm font-semibold text-foreground transition-colors">
              Start Ideation
        ...
        >
          ...
          <div className="relative h-full rounded-3xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl p-8 space-y-6 flex flex-col items-center text-center group-hover:border-emerald-500/30 transition-colors">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-foreground">Direct Creation</h3>
              <p className="text-muted-foreground leading-relaxed text-sm max-w-xs">
                Have a clear vision already? Jump straight into building your workspace and defining specs.
              </p>
            </div>
            <div className="flex flex-wrap gap-2 justify-center">
              <span className="px-2.5 py-1 rounded-full bg-emerald-500/10 text-success text-[11px] font-medium">Quick Setup</span>
              <span className="px-2.5 py-1 rounded-full bg-white/[0.05] text-muted-foreground text-[11px] font-medium">Blank Canvas</span>
              <span className="px-2.5 py-1 rounded-full bg-white/[0.05] text-muted-foreground text-[11px] font-medium">Full Control</span>
            </div>
            <div className="flex-1" />
            <div className="w-full flex items-center justify-center gap-2 rounded-xl bg-white/[0.06] hover:bg-white/[0.1] py-3 text-sm font-semibold text-foreground transition-colors">
              Create Manually
